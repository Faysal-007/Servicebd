                ...
                <div class="col-md-12 blog-holder">
                    <div class="row">
                        ...
                        <div class="col-md-4 blog-item-wrapper">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <a href="single.html"><img src="{{asset('user/assets/img/blog-1.jpg')}}" alt=""></a>
                                </div>
                                <div class="blog-text">
                                    <div class="blog-tag">
                        ...
                        <div class="col-md-4 blog-item-wrapper">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <a href="#"><img src="{{asset('user/assets/img/blog-2.jpg')}}" alt=""></a>
                                </div>
                                <div class="blog-text">
                                    <div class="blog-tag">
                        ...
                        <div class="col-md-4 blog-item-wrapper">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <a href="#"><img src="{{asset('user/assets/img/blog-3.jpg')}}" alt=""></a>
                                </div>
                                <div class="blog-text">
                                    <div class="blog-tag">
