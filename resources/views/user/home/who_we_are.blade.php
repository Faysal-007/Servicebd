        ...
        <div class="section-content">
            ...
            <div class="row text-center">
                <div class="col-md-4 col-sm-6 ">
                    <img class="rounded-circle" src="{{asset('user/assets/icons/animat-checkmark.gif')}}" alt="Generic placeholder image" width="140" height="140">
                ...
                <!-- /.col-md-4 col-sm-6  -->
                <div class="col-md-4 col-sm-6 ">
                    <img class="rounded-circle" src="{{asset('user/assets/icons/animat-customize.gif')}}" alt="Generic placeholder image" width="140" height="140">
                ...
                <!-- /.col-md-4 col-sm-6  -->
                <div class="col-md-4 col-sm-6 ">
                    <img class="rounded-circle" src="{{asset('user/assets/icons/animat-responsive.gif')}}" alt="Generic placeholder image" width="140" height="140">
